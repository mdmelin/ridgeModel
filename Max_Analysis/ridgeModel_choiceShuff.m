function ridgeModel_choiceShuff(cPath,Animal,Rec,glmFile,dType)
...
bhv.ResponseSide = bhv.ResponseSide(randperm(length(bhv.ResponseSide)));
%% load behavior data
...
[Vm, fullBeta, R, fullIdx, fullRidge, fullLabels, fullLabelInds, fullMap, fullMovie] = crossValModel(labels);
save([cPath glmFile 'choiceshuffle.mat'],'regIdx','rejIdx','Vm', 'fullBeta', 'fullIdx', 'R', 'fullLabels', 'fullLabelInds', 'fullRidge', 'regLabels', 'fullMap', 'fullMovie','-v7.3'); %this saves model info based on state only
