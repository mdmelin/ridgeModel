function ridgeModel_responseRewardShuffDeleteme(cPath,Animal,Rec,glmFile,dType)
...
rewardedshuff = SessionData.Rewarded(randperm(length(SessionData.Rewarded))); %shuffle reward
...
save([cPath glmFile 'fullresponserewardshuff.mat'],'regIdx','rejIdx','Vm', 'fullBeta', 'fullIdx', 'R', 'fullLabels', 'fullLabelInds','fullRidge', 'regLabels', 'fullMap', 'fullMovie','-v7.3'); %this saves model info based on state only
