function ridgeModel_deleteme2(cPath,Animal,Rec,glmFile,dType)
...
trialstates = datasample([1 2 3],trialCnt)';
%% load behavior data
...
save([cPath glmFile 'onlyRAND.mat'],'regIdx','rejIdx','Vm', 'fullBeta', 'fullIdx', 'stateR', 'fullLabels', 'fullRidge', 'regLabels', 'fullMap', 'fullMovie','-v7.3'); %this saves model info based on state only
