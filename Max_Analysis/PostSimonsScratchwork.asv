...
%% Do FULL design matrix shuffles for reward
parfor i = 1:length(animals)
    animals{i}
    encodingrecs{i}
    ridgeModel_stateEncodingAligned(cPath,animals{i},encodingrecs{i},glmFile,[],[]);
...
%% plot the deltaRsquared for that 
clear h s d r h2 s2 d2 r2
clim = [0 .9];
parfor i = 1:length(encodingrecs)
    h(i) = getRSquaredNew(animals{i},encodingrecs{i},'allaudio_.mat') - getRSquaredNew(animals{i},encodingrecs{i},'allaudio_handleRewardshuff.mat');
    s(i) = getRSquaredNew(animals{i},encodingrecs{i},'allaudio_.mat') - getRSquaredNew(animals{i},encodingrecs{i},'allaudio_stimRewardshuff.mat');
    d(i) = getRSquaredNew(animals{i},encodingrecs{i},'allaudio_.mat') - getRSquaredNew(animals{i},encodingrecs{i},'allaudio_delayRewardshuff.mat');
    r(i) = getRSquaredNew(animals{i},encodingrecs{i},'allaudio_.mat') - getRSquaredNew(animals{i},encodingrecs{i},'allaudio_responseRewardshuff.mat');
end
