function ridgeModel_delayRewardShuffDeleteme(cPath,Animal,Rec,glmFile,dType)
...
save([cPath glmFile 'fulldelayrewardshuff.mat'],'regIdx','rejIdx','Vm', 'fullBeta', 'fullIdx', 'R', 'fullLabels', 'fullLabelInds','fullRidge', 'regLabels', 'fullMap', 'fullMovie','-v7.3'); %this saves model info based on state only
