...
fastHiPupilDigital = cat(1,dMat2{:});
...
fullR = [timeR ChoiceR rewardR lGrabR lGrabRelR rGrabR rGrabRelR ...
    ...
    nextChoiceR waterR piezoR whiskR noseR fastPupilAnalog fastPupilDigital fastHiPupilDigital ...
...
regLabels = {
    ...
    'prevReward' 'prevChoice' 'nextChoice' 'water' 'piezo' 'whisk' 'nose' 'fastPupilAnalog' 'fastPupilDigital' 'fastHiPupilDigital' 'slowPupil' 'face' 'body' 'Move' 'bhvVideo'};
...
regIdx = [
    ...
    ones(1,size(fastPupilR,2))*find(ismember(regLabels,'fastPupilAnalog')) ...
    ones(1,size(fastPupilR,2))*find(ismember(regLabels,'fastPupilDigital')) ...
    ones(1,size(fastPupilR,2))*find(ismember(regLabels,'fastPupilHiDigital')) ...
